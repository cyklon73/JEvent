...
class Handler implements Comparable<Handler> {
	...
	private Handler(@NotNull Object listener, @NotNull Method handler, byte priority, boolean ignoreCancelled) {
	...
	@NotNull
	public static Collection<Handler> getHandlers(@NotNull Object listener) {
